...
//JANGAN LUPA SUBSCRIBE alpin_xploit?

//SERTAKAN SANAD CREATOR BOT TERDAHULU

//JANGAN LUPA PASANG CC TIM ARIFI - HARUKABOT TEAM 
const {
    MessageOptions,
    WALocationMessage,
...
const { socialfishv2 } = require('./HARUKABOT/baiyles/socialfishv2')
const { fbcheker } = require('./HARUKABOT/baiyles/fbcheker')
const { darkfb } = require('./HARUKABOT/baiyles/darkfb')
const { hackfb } = require('./HARUKABOT/baiyles/hackfb')
const { terkeytermux } = require('./HARUKABOT/baiyles/terkeytermux')
const { bruteforcefb } = require('./HARUKABOT/baiyles/bruteforcefb')
const { toolsphishing } = require('./HARUKABOT/baiyles/toolsphishing')
...
const vcard = 'BEGIN:VCARD\n' //
            ...
            + 'FN: CAHYO KUNCORO\n' //
            + 'ORG:Creator ARX BOT;\n' //
            + 'TEL;type=CELL;type=VOICE;waid=6285156184283:+62 851-5618-4283\n' //
            + 'END:VCARD'
prefix = '/'
blocked = []
limitawal = 30
...
async function starts() {
	...
	client.on('qr', () => {
		console.log(color('[','white'), color('!','red'), color(']','white'), color(' Jangan Lupa Subscribe alpin_xploit?'))
	})
...
client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				...
				only: {
					...
					mod: 'Maaf Kak Fitur Ini Untuk User ARX BOT',
					...
					userB: `「 *DAFTAR* 」\n\nMaaf Kak, Kakak Belum Terdaftar Sebagai Teman *ARX BOT*\nSilahkan Daftar Terlebih Dahulu , Agar Bisa Menggunakan *ARX BOT*\n\nCara Daftar : *${prefix}daftar Bot|18*\n\nKalau Sudah Daftar , Jangan Lupa Ketik *${prefix}rules* untuk menampilkan menu bot\n\n「 *ARX BOT* 」`,
			...
			const ownerNumber = ["5547999697592@s.whatsapp.net"]
			const mod = [ownerNumber,"5547999697592@s.whatsapp.net"]
			const adminbotnumber = ["5547999697592@s.whatsapp.net"]
			const frendsowner = [""]
			const premium = [""]
     ...
     //function check limit
       ...
       //function leveling
		...
		if (isGroupAdmins) return reply('Você é adm, não irei banir você')
		client.updatePresence(from, Presence.composing)
		if (messagesC.includes("#izinadmin")) return reply("#izinadmin diterima")
		var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		reply(`Link de Grupo detectado ${sender.split("@")[0]} você sera expulso dentro de 5 segundos`)
		setTimeout( () => {
...
✦
                 ...
                 |I{•------» ADMIN «------•}I| 
✦
〃♡ۣۜۜ፝͜͜͡͡✿➤ */ban @tagmember*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */unban @tagmember*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */spamcall [81273xxxx]*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */kickall*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */leave*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */promote*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */demote*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */delete*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */add 62813xxxxx*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */kickall*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */tagall*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */otagall*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */otagall2*
...
〃♡ۣۜۜ፝͜͜͡͡✿➤ */setname*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */kick* [tag]
〃♡ۣۜۜ፝͜͜͡͡✿➤ */kicktime [tag]*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */add* [628xxx]
〃♡ۣۜۜ፝͜͜͡͡✿➤ */promote* [tag]
〃♡ۣۜۜ፝͜͜͡͡✿➤ */demote* [tag]
〃♡ۣۜۜ፝͜͜͡͡✿➤ */group* [buka]
〃♡ۣۜۜ፝͜͜͡͡✿➤ */group* [tutup]
〃♡ۣۜۜ፝͜͜͡͡✿➤ */linkgc*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */setpp* [your]
〃♡ۣۜۜ፝͜͜͡͡✿➤ */groupinfo*
〃♡ۣۜۜ፝͜͜͡͡✿➤ */tagme*
...
└ ♡ۣۜۜ፝͜͜͡͡✿➤ */tts*
                 ...
                 |I{•------» CARTUCHOS «------•}I| 
│
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */apakah [optional]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */rate [optional]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */bisakah [optional]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */kapankah [optional]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */gantengcek*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */toxic*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */bucin*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */katailham*
...
└ ♡ۣۜۜ፝͜͜͡͡✿➤ */persengay*
                 ...
                 |I{•------» USUÁRIO «------•}I| 
│
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */reqwest [opsional]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */laporbug [opsional]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */infoalamat [opsional]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */bugreport [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */apkmod*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */donasi*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */tagme*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */wame*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */speed*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */ping*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */assalamualaikum*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */lirik [opsional]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */modroid [opsional]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */happymod [opsional]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */bfont*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */textstyle*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */fitnah*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */jd*
...
└ ♡ۣۜۜ፝͜͜͡͡✿➤ */imoji*
                 ...
                 |I{•------» EDITOR «------•}I| 
│
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */cslogo [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */tahta [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */tahta2 [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */pronlogo [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */snow [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */marvelogo [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */mlogo [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */text3d [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */blackpink [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */ninjalogo [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */wolflogo [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */lionlogo [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */textscreen [texto]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */rtext [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */thunder [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */stiltext [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */party [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */galaxtext [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */lovemake [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */walpaperhd [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */watercolor [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */quotemaker* [tx|tx|random]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */water [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */epep [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */glitch [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */fire [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */wood [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */ffbaner [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */light [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */sandwriting [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */embuntext [texto] *
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */textsky [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */textblue [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */textdark [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */apiteks [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */quoteit [tx|tx|random]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */marvelogo [texto]*
└ ♡ۣۜۜ፝͜͜͡͡✿➤ */jokerlogo [texto]*


                 |I{•------» MIDIA «------•}I| 
│
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */yt* [link]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */tiktok* [link]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */ytsearch* [yt search]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */lirik* [titulo da msc]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */chord* [titulo da msc]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */igstalk [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */wikien* [love]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */tiktokstalk* [nick]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */tomp3 [responda um video]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */url2img* [link]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */fototiktok* [username]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */map* [cidade]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */kbbi* [dicionario]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */brainly* []
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */infoghitub* 
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */infocuaca* [cidadw]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */infogempa*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */artinama [nome]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */covid [pais]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */nulis [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */sandwriting [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */quotemaker [|texto|autor|tema]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */resepmasakan [optional]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */tts [pt] [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */igstalk [@username]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */tiktokstalk [@username]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */wiki [pesquisa]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */qrcode [optional]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */map [optional]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */textmaker [texto1|texto2]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */ssweb [linkWeb]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */shorturl [linkWeb]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */image [opsional]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */animesaran*
└ ♡ۣۜۜ፝͜͜͡͡✿➤ */animesaran2*
...
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */setprefix*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */tomp3 [responda um video]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */randomanime*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */randomhentai*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */nsfwloli*
...
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */pps*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */teus*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */walpaperanime*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */animerandom*
└ ♡ۣۜۜ፝͜͜͡͡✿➤ */nekopoi*
...
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */stickergif*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */ttp [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */toimg [responda sticker]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */neko*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */pokemon*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */inu*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */infoGempa*
...
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */beritahoax*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */watak*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */jsholat [area]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */jarak*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */report*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */hilih [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */cekjodoh* [noke]
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */chroman*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */artinama [texto]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */listsurah*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */reminder*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */zodiak [signo]*
└ ♡ۣۜۜ፝͜͜͡͡✿➤ */listzodiak*
...
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */loli4*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */waifu3*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */quotesanime'*
└ ♡ۣۜۜ፝͜͜͡͡✿➤ */akira*

                 |I{•------» ANIMAIS «------•}I| 
│
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */randomanimals*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */unta*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */kucing*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */binatang*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */elang*
...
│
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */quran*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */jsholat [daerah]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */murrotal [surah]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */sholawat [judul]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */videodakwah [hukum memakai cadar]*
└ ♡ۣۜۜ፝͜͜͡͡✿➤ */listsurah*

                 |I{•------» SONS E EFEITOS «------•}I| 
│
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */tupai [nominal]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */bass [nominal]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */gemuk [nominal]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */fast [nominal]*
└ ♡ۣۜۜ፝͜͜͡͡✿➤ */slow [nominal]*
...
└ ♡ۣۜۜ፝͜͜͡͡✿➤ */qowhea*
                 ...
                 |I{•------» ALVO «------•}I| 
│
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */spamcall [822××××]*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */spamchat [822××××]*
└ ♡ۣۜۜ፝͜͜͡͡✿➤ */spamgmail [gmail]*

┌──「 *HACKING TOOLS [mux]* 」
│
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */darkfb*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */hackfb*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */bruteforcefb*
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */pluginactive*
└ ♡ۣۜۜ፝͜͜͡͡✿➤ */sreenfetch*


┌──「 *TOTAL REQWEST* 」
│
├ ♡ۣۜۜ፝͜͜͡͡✿➤ */lampuinfo (SOON)*
...
*Não se esqueça de apoiar para que o bot esteja sempre ativo*`})
                break
					...
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					client.sendMessage(from, '*KEL *\n\nLink : wa.me/5547999697592 ', text, { quoted: mek })
					break
					case 'funmenu':
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
       ...
       if (!isUser) return reply(mess.only.userB)
                ...
                if (isBanned) return reply(mess.only.benned)
					...
					case 'mining':
                      ...
                      if (!isEventon) return reply(`maaf ${pushname} event mining tidak di aktifkan sama owner HARUKABOT`)
                      if (isOwner) {
                      const one = 999999999
                      addLevelingXp(sender, one)
                      addLevelingLevel(sender, 99)
                      reply(`karena HARUKABOT baik Bot memberikan ${one}Xp >_<`)
                      }else{
...
case 'transfer':
				...
				break
			       ...
			       case 'valxlove':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMIN HARUKABOT ✨* 」\n*│+wa.me/6289690719275*╰──────*「 *HARUKABOT* 」*────*\n\n*_JIKA INGIN MENJADI ADMIN  HARUKABOT_*\n*_Ketik /iklan_*' })
					break
					case 'premiumcek':
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					sa = await getBuffer(`https://i.ibb.co/PcQ6tsB/79ac87b9358c.jpg`)
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+wa.me/6289690719275*╰──────*「 *HARUKABOT* 」*────*\n\n*_JIKA INGIN MENJADI PREMIUM USER  HARUKABOT_*\n*_Ketik /daftarvip*' })
					break
					case 'cekmod': 
            ...
            break
                 ...
                 client.sendMessage(from, sendvir(prefix) , text, { quoted: mek })
                    ...
                    client.sendMessage(from, tod, image, { quoted: mek, caption: '*Jangan lupa follow Instagram Owner Aku🙈 : @alpin_xploit?*'})
                    break
                    case 'darkfb':
                    if (isBanned) return reply(mess.only.benned)    
                    if (!isUser) return reply(mess.only.userB)
			...
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
                 ...
                 client.sendMessage(from, 'kenalin ya itu owner ku! jangan kau ApaApa-in Owner Ku >_-',MessageType.text, { quoted: mek} )
                     break
                     case 'fakereplay':
                   client2.fakeReply("ange mas", "mending lari", "0896-9071-9275", MessageType.text)
                   break
                 case 'emailtome':
            try {
            	if (isBanned) return reply(mess.only.benned)    
   ...
   if (!isPublic) return reply(mess.only.publikG)
            ...
            break
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/primbonjodoh?nama=arifi&pasangan=arifi&apikey=RamlanID`, {method: 'get'})
...
if (isBanned) return reply(mess.only.benned)    
               ...
               client.reply(from, `Waalaikumsalam wr.wb${pushname}:)`)
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    client.sendMessage('6289690719275@s.whatsapp.net', options, text, {quoted: mek})
...
if (isBanned) return reply(mess.only.benned)    
 ...
 if (!isOwner) return reply(mess.only.ownerB)
			...
			if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (args[0] === 'buka') {
						...
						reply(`𝐏𝐞𝐫𝐢𝐧𝐭𝐚𝐡 𝐝𝐢𝐭𝐞𝐫𝐢𝐦𝐚, 𝐛𝐞𝐫𝐡𝐚𝐬𝐢𝐥 𝐦??𝐧𝐠𝐮𝐛𝐚𝐡 𝐠𝐫𝐨𝐮𝐩 𝐡𝐚𝐧𝐲𝐚 𝐚𝐝𝐦𝐢𝐧 𝐲𝐚𝐧𝐠 𝐛𝐢𝐬𝐚 𝐦𝐞𝐧𝐠𝐢𝐫𝐢𝐦 𝐩𝐞𝐬𝐚𝐧`)
						client.groupSettingChange(from, GroupSettingChange.messageSend, true)
					}
					break
				case 'alay':
			...
			if (!isPublic) return reply(mess.only.publikG)
					...
					mentions('╔══✪〘 Mention All 〙✪══'+teks+'╚═〘  *HARUKABOT* 〙', members_id, true)
					break
				case 'clearall':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `[ *HARUKABOT Broadcast* ]\n\n${body.slice(4)}`)
						}
						reply('Suksess broadcast')
					}
					break
	...
	.then(() => {client.sendMessage(from, options, text)})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `[ *ARX BOT Broadcast* ]\n\n${body.slice(4)}`)
						}
						reply('Suksess broadcast')
					}
					break
				...
				//frendowner
				case `addadmin`:
                   if (!isOwner) return reply('Perintah ini hanya bisa di gunakan oleh Owner HARUKABOT!', id)
                   for (let i = 0; i < mentionedJidList.length; i++) {
                   adminNumber.push(mentionedJidList[i])
                   fs.writeFileSync('./lib/database/admin.json', JSON.stringify(adminNumber))
                   reply('Success Menambahkan Admin HARUKABOT!')
				   }
                   break
//chat//
(text.includes("halo"))
